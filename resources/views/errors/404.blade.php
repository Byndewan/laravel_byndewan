            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    <div class="error-container">
                        ...
                        <h1 class="error-title font-weight-bold">Halaman Tidak Ditemukan</h1>
                        <p class="error-description text-muted mb-4">
                            Maaf, halaman yang Anda cari tidak dapat ditemukan. Mungkin halaman telah dihapus atau alamatnya salah.
                        </p>
